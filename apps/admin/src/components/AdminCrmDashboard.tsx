...
function AdminLoginScreen({
  ...
  async function handleGoogleButtonClick() {
    ...
    try {
      ...
      try {
        const result = await createApiClient().loginWithGoogle({ credential: fbUser.idToken, role: "ADMIN" });
      ...
      setError(errObj?.message || "Google admin sign in failed.");
    } finally {
      setBusy(false);
    }
  }
        ...
        {mode === "checking" ? (
          ...
          <div className="admin-auth-grid">
            ...
            <div className="admin-auth-card">
              ...
              <p>Continue with your authorized Google admin account.</p>
